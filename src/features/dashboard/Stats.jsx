...
export function Stats({bookings, confirmedStays,cabinCount, numDays}) {
  ...
  return (
    <>
        ...
        <Stat title='Occupance rate' color='yellow' icon={<HiOutlineChartBar />} value={Math.round(occupancy*100)+"%"}/>
